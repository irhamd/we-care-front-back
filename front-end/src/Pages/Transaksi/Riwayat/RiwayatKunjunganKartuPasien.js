...
function RiwayatKunjunganKartuPasien(pr) {
    ...
    useEffect(() => {
        ...
        if(pr.ininoregistrasi){
            getGetailByNorec(pr.ininoregistrasi)
        }
    }, [pr.ininoregistrasi])
    ...
    return (
        <div>
            ...
            <Drawer
                ...
                // closable={false}
                onClose={() => pr.onClose()}
                visible={pr.ininoregistrasi ? true : false}
            // key={placement}
            >
...
export default RiwayatKunjunganKartuPasien
