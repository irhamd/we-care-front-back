  ...
  <div className="container-fluid page-body-wrapper">
    <div id="theme-settings" className="settings-panel">
      ...
      <div className="sidebar-bg-options selected" id="sidebar-default-theme">
        <div className="img-ss rounded-circle bg-light border mr-3" /> Default
      </div>
    ...
    <nav className="navbar col-lg-12 col-12 p-lg-0 fixed-top d-flex flex-row" style={{ background :"orange" , color:"black" }}>
      <div className="navbar-menu-wrapper d-flex align-items-stretch justify-content-between" style={{ background :"rgb(32 63 88 / 97%)", color:"black" }}>
        ...
        <ul className="navbar-nav navbar-nav-right ml-lg-auto" style={{ color:"yellow" }}>
          <li className="nav-item dropdown d-none d-xl-flex border-0" >
            <a className="nav-link dropdown-toggle" id="languageDropdown" href="#" data-toggle="dropdown" style={{ color:"#258fe6f7" }}>
              <i className="mdi mdi-earth"  style={{ color:"#258fe6f7" }}/> English </a>
          ...
          <li className="nav-item nav-profile dropdown border-0">
            <a className="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown" style={{ color:"#258fe6f7" }}> 
      ...
      <div className="content-wrapper pb-0">
        <div className="page-header flex-wrap">
          ...
          <div className="d-flex">
            <button type="button" className="btn btn-sm bg-white btn-icon-text border">
              <i className="mdi mdi-email btn-icon-prepend" /> Email </button>
            <button type="button" className="btn btn-sm bg-white btn-icon-text border ml-3">
              <i className="mdi mdi-printer btn-icon-prepend" /> Print </button>
                ...
                <div className="row">
                  ...
                  <div className="col-sm-5 text-md-right">
                    <button type="button" className="btn btn-icon-text mb-3 mb-sm-0 btn-inverse-primary font-weight-normal">
                      <i className="mdi mdi-email btn-icon-prepend" />Download Report </button>
                  </div>
                  <br/>
                </div>
                <div className="row">
          ...
          <div className="col-xl-4 col-sm-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <a className="text-black mt-3 d-block font-weight-medium h6" href="#">View all <i className="mdi mdi-chevron-right" /></a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="col-xl-4 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                  ...
                  <span className="d-flex justify-content-between">
                    ...
                    <span className="dropdown dropleft d-block">
                      <span id="dropdownMenuButton1" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                        <span><i className="mdi mdi-dots-horizontal" /></span>
                      </span>
                ...
                <a className="text-black mt-3 mb-0 d-block h6" href="#">View all <i className="mdi mdi-chevron-right" /></a>
              </div>
            </div>
          </div>
        </div>
        <div className="row">
                      ...
                      <div className="d-flex pt-1 align-items-center">
                        ...
                        <div className="dropdown dropleft pl-1 pt-3">
                          <div id="dropdownMenuButton2" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                            <p><i className="mdi mdi-dots-vertical" /></p>
                          </div>
          ...
          <div className="col-xl-4 col-md-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <div id="inline-datepicker" className="datepicker table-responsive" />
              </div>
            </div>
          </div>
